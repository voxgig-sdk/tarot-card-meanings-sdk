...
#      offline in seeded test mode (TarotCardMeaningsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TarotCardMeanings_sdk.rb")
  SDK_CLASS = "TarotCardMeaningsSDK"
  ...
  SDK_BASE = "TarotCardMeanings_sdk"
