...
|---|---|---|
| `ts/` | @voxgig-sdk/tarot-card-meanings-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/tarot-card-meanings-sdk \
      --repository voxgig-sdk/tarot-card-meanings-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/tarot-card-meanings-sdk` shows it, and
`npm trust revoke @voxgig-sdk/tarot-card-meanings-sdk --id=<id>` removes it.
