...
// TarotCardMeanings SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TarotCardMeaningsOmni::makeStructRunner(
    ...
    {
        return TarotCardMeaningsOmni::objmodel(TarotCardMeaningsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return TarotCardMeaningsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return TarotCardMeaningsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TarotCardMeaningsOmni::structfix($now, Struct::undef()))
                        !== json_encode(TarotCardMeaningsOmni::structfix($val, Struct::undef()))) {
