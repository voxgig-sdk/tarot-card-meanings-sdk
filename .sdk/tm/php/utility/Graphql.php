...
// TarotCardMeanings SDK utility: graphql
//
...
class TarotCardMeaningsGraphql
{
    ...
    // equivalent.
    public static function body(TarotCardMeaningsContext $ctx): mixed
    {
    ...
    public static function errors(TarotCardMeaningsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
