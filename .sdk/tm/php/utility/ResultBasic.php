...
// TarotCardMeanings SDK utility: result_basic

class TarotCardMeaningsResultBasic
{
    public static function call(TarotCardMeaningsContext $ctx): ?TarotCardMeaningsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof TarotCardMeaningsError) ? $result->err->msg : (string)$result->err;
