...
// TarotCardMeanings SDK utility: make_options

class TarotCardMeaningsMakeOptions
{
    ...
    public static function call(TarotCardMeaningsContext $ctx): array
    {
        ...
        //
        // `TarotCardMeaningsSchema::optspec()` is built from the model:
        ...
        $optspec = TarotCardMeaningsSchema::optspec();
