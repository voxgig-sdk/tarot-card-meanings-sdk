...
// TarotCardMeanings SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TarotCardMeaningsTransformResponse
{
    public static function call(TarotCardMeaningsContext $ctx): mixed
    {
        ...
        $transform = TarotCardMeaningsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
