...
// TarotCardMeanings SDK utility type

class TarotCardMeaningsUtility
{
    ...
    public static function copy(TarotCardMeaningsUtility $src): TarotCardMeaningsUtility
    {
        $u = new TarotCardMeaningsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
