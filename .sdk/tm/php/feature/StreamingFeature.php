...
// TarotCardMeanings SDK streaming feature
...
class TarotCardMeaningsStreamingFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _iterate(TarotCardMeaningsResult $result): \Generator
    {
    ...
    private function _streamable(TarotCardMeaningsContext $ctx): bool
    {
