...
// TarotCardMeanings SDK ratelimit feature
...
class TarotCardMeaningsRatelimitFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _acquire(TarotCardMeaningsContext $ctx): void
    {
    ...
    private function _track(TarotCardMeaningsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
