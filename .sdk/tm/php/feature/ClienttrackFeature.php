...
// TarotCardMeanings SDK clienttrack feature
...
class TarotCardMeaningsClienttrackFeature extends TarotCardMeaningsBaseFeature
{
    ...
    public function PostConstruct(TarotCardMeaningsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TarotCardMeanings-SDK';
