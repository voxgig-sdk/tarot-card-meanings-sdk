...
Card names, descriptions, and divinatory meanings based on AE Waite's Pictorial Key to the Tarot (1910) for the Rider-Waite-Smith deck.

Learn more about Tarot Card Meanings at [tarot-api-3hv5.onrender.com](https://tarot-api-3hv5.onrender.com).
...
$cards = $client->Card()->list();
print_r(array_map(fn($item) => $item->data_get(), $cards));
