...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/tarot-card-meanings` | `npm install @voxgig-sdk/tarot-card-meanings` |
| Python | `voxgig-sdk-tarot-card-meanings` | `pip install voxgig-sdk-tarot-card-meanings` |
| PHP | `voxgig-sdk/tarot-card-meanings` | `composer require voxgig-sdk/tarot-card-meanings` |
| Golang | `github.com/voxgig-sdk/tarot-card-meanings-sdk/go` | `go get github.com/voxgig-sdk/tarot-card-meanings-sdk/go` |
| Ruby | `voxgig-sdk-tarot-card-meanings` | `gem install voxgig-sdk-tarot-card-meanings` |
| Lua | `voxgig-sdk-tarot-card-meanings` | `luarocks install voxgig-sdk-tarot-card-meanings` |
