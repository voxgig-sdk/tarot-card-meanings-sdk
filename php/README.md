# TarotCardMeanings PHP SDK



The PHP SDK for the TarotCardMeanings API — an entity-oriented client using PHP conventions.
...
```
php/
├── tarotcardmeanings_sdk.php          -- Main SDK class
...
The main class (`tarotcardmeanings_sdk.php`) exports the SDK class
