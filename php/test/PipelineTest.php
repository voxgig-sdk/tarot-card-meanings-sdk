...
// TarotCardMeanings SDK pipeline test
//
...
{
    private static function utility(): TarotCardMeaningsUtility
    {
        return new TarotCardMeaningsUtility();
    }
    ...
    private static function ctx(array $over = []): TarotCardMeaningsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TarotCardMeaningsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TarotCardMeaningsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TarotCardMeaningsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TarotCardMeaningsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TarotCardMeaningsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TarotCardMeaningsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TarotCardMeaningsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TarotCardMeaningsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TarotCardMeaningsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TarotCardMeaningsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TarotCardMeaningsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TarotCardMeaningsResponse([]),
            'result' => new TarotCardMeaningsResult([]),
        ]);
        [, $err] = TarotCardMeaningsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TarotCardMeaningsSpec([]),
            'response' => null,
            'result' => new TarotCardMeaningsResult([]),
        ]);
        [, $err] = TarotCardMeaningsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TarotCardMeaningsSpec(['step' => 's']),
            'response' => new TarotCardMeaningsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TarotCardMeaningsResult([]),
        ]);
        [, $err] = TarotCardMeaningsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TarotCardMeaningsSpec(['step' => 's']),
            'response' => new TarotCardMeaningsResponse(self::resp(200, ['v' => 1])),
            'result' => new TarotCardMeaningsResult([]),
        ]);
        [, $err] = TarotCardMeaningsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TarotCardMeaningsSpec(['step' => 's']),
            'response' => new TarotCardMeaningsResponse(self::resp(200, ['v' => 2])),
            'result' => new TarotCardMeaningsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TarotCardMeaningsMakeResponse::call($ctx);
    ...
    {
        $preset = new TarotCardMeaningsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TarotCardMeaningsSpec([]),
            'response' => new TarotCardMeaningsResponse([]),
            'result' => new TarotCardMeaningsResult([]),
        ...
        [$got, $err] = TarotCardMeaningsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TarotCardMeaningsResult([])]);
        [, $err] = TarotCardMeaningsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TarotCardMeaningsSpec([]), 'result' => null]);
        [, $err] = TarotCardMeaningsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TarotCardMeaningsSpec(['step' => 's']),
            'result' => new TarotCardMeaningsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TarotCardMeaningsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TarotCardMeaningsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TarotCardMeaningsSpec(['step' => 's']),
            'result' => new TarotCardMeaningsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TarotCardMeaningsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TarotCardMeaningsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TarotCardMeaningsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TarotCardMeaningsSpec([]),
            'result' => new TarotCardMeaningsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TarotCardMeaningsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TarotCardMeaningsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TarotCardMeaningsError('boom', 'boom');
        $utility->fetcher = function (TarotCardMeaningsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TarotCardMeaningsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TarotCardMeaningsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TarotCardMeaningsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TarotCardMeaningsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TarotCardMeaningsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TarotCardMeaningsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TarotCardMeaningsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TarotCardMeaningsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TarotCardMeaningsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TarotCardMeaningsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TarotCardMeaningsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TarotCardMeaningsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TarotCardMeaningsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TarotCardMeaningsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TarotCardMeaningsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TarotCardMeaningsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TarotCardMeaningsResult(['ok' => false])]);
        $this->expectException(TarotCardMeaningsError::class);
        TarotCardMeaningsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TarotCardMeaningsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TarotCardMeaningsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TarotCardMeaningsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TarotCardMeaningsBaseFeature();
        $b = new TarotCardMeaningsBaseFeature();
        TarotCardMeaningsFeatureAdd::call($ctx, $a);
        TarotCardMeaningsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TarotCardMeaningsBaseFeature
    {
        $f = new TarotCardMeaningsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TarotCardMeaningsFeatureAdd::call($ctx, self::named_feature('a'));
        TarotCardMeaningsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TarotCardMeaningsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TarotCardMeaningsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TarotCardMeaningsFeatureAdd::call($ctx, $replace);
        ...
        TarotCardMeaningsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TarotCardMeaningsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TarotCardMeaningsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TarotCardMeaningsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TarotCardMeaningsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TarotCardMeaningsResponse(['headers' => null]),
            'result' => new TarotCardMeaningsResult([]),
        ]);
        TarotCardMeaningsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TarotCardMeaningsResultBody::call($ctx);
