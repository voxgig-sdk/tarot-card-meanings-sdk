...
class CardEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TAROTCARDMEANINGS_TEST_CARD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function card_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TAROTCARDMEANINGS_TEST_CARD_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["TAROTCARDMEANINGS_TEST_CARD_ENTID"]);
    ...
    return [
        ...
        "env" => $env,
        "explain" => $env["TAROTCARDMEANINGS_TEST_EXPLAIN"] === "TRUE",
        "live" => $live,
