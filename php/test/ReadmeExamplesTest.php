...
// TarotCardMeanings SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TarotCardMeaningsSDK::test)
...
{
    private const SDK_CLASS = 'TarotCardMeaningsSDK';
    ...
    private const SDK_BASE = 'tarotcardmeanings_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../tarotcardmeanings_sdk.php';
