...
// TarotCardMeanings SDK timeout feature
...
class TarotCardMeaningsTimeoutFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _with_timeout(TarotCardMeaningsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TarotCardMeaningsContext $_ctx, float $ms): void
    {
        $client = $this->client;
