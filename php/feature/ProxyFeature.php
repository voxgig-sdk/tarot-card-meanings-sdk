...
// TarotCardMeanings SDK proxy feature
...
class TarotCardMeaningsProxyFeature extends TarotCardMeaningsBaseFeature
{
    ...
    public function init(TarotCardMeaningsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TarotCardMeaningsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
