...
// TarotCardMeanings SDK rbac feature
...
class TarotCardMeaningsRbacFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _required(TarotCardMeaningsContext $ctx): ?string
    {
    ...
    private function _reject(TarotCardMeaningsContext $ctx, string $required): void
    {
    ...
    private function _track(TarotCardMeaningsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
