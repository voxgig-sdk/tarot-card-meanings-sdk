...
// TarotCardMeanings SDK telemetry feature
...
class TarotCardMeaningsTelemetryFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _close(TarotCardMeaningsContext $ctx, bool $ok): void
    {
