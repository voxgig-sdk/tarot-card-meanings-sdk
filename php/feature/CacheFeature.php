...
// TarotCardMeanings SDK cache feature
...
class TarotCardMeaningsCacheFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _through(TarotCardMeaningsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
