...
// TarotCardMeanings SDK netsim feature
...
class TarotCardMeaningsNetsimFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _simulate(TarotCardMeaningsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TarotCardMeaningsContext $ctx, array $applied): void
    {
        $client = $this->client;
