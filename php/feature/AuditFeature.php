...
// TarotCardMeanings SDK audit feature
...
class TarotCardMeaningsAuditFeature extends TarotCardMeaningsBaseFeature
{
    ...
    private function _emit(TarotCardMeaningsContext $ctx, string $outcome): void
    {
