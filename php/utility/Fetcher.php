...
// TarotCardMeanings SDK utility: fetcher

class TarotCardMeaningsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TarotCardMeaningsSDK/1.0)';
    ...
    public static function call(TarotCardMeaningsContext $ctx, string $fullurl, array $fetchdef): array
    {
