...
function runner.env_override(m)
  local live = runner.getenv("TAROT_CARD_MEANINGS_TEST_LIVE")
  local override = runner.getenv("TAROT_CARD_MEANINGS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TAROT_CARD_MEANINGS_TEST_EXPLAIN")
