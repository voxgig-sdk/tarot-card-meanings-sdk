...
function runner.env_override(m)
  local live = runner.getenv("TAROTCARDMEANINGS_TEST_LIVE")
  local override = runner.getenv("TAROTCARDMEANINGS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TAROTCARDMEANINGS_TEST_EXPLAIN")
