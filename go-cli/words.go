...
func registerSDKWords(r *eng.Registry, client *sdk.TarotCardMeaningsSDK) {
...
func runOp(client *sdk.TarotCardMeaningsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
