...
AQL-driven CLI and REPL for the TarotCardMeanings SDK. Positional arguments are
...
```sh
go build -o tarot-card-meanings-cli ./...
```
...
./tarot-card-meanings-cli load 1 card
./tarot-card-meanings-cli load '{id:1}' card
