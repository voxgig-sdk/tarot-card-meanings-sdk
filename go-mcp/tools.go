...
type Args struct {
	Entity string         `json:"entity" jsonschema:"card"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TarotCardMeaningsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "tarot-card-meanings_list",
		Description: "List records from TarotCardMeanings. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "tarot-card-meanings_load",
		Description: "Load a single record from TarotCardMeanings. " +
...
func runOp(client *sdk.TarotCardMeaningsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TarotCardMeaningsSDK, name string) (sdk.TarotCardMeaningsEntity, error) {
