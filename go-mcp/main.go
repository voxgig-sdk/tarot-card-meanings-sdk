// Command TarotCardMeanings-mcp is an MCP server exposing the TarotCardMeanings
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TarotCardMeanings_list  — list records of an entity
//	TarotCardMeanings_load  — load a single record of an entity
//
