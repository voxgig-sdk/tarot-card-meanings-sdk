...
The TypeScript SDK for the TarotCardMeanings API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new TarotCardMeaningsSDK({ apikey: '...' })
