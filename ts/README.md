# TarotCardMeanings TypeScript SDK



The TypeScript SDK for the TarotCardMeanings API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/tarot-card-meanings-sdk/releases](https://github.com/voxgig-sdk/tarot-card-meanings-sdk/releases)
...
```ts
new TarotCardMeaningsSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `TarotCardMeaningsSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `TarotCardMeaningsSDK.test(testopts?, sdkopts?)` | `TarotCardMeaningsSDK` | Create a test-mode client. |
...
tarot-card-meanings/
├── src/
│   ├── TarotCardMeaningsSDK.ts        # Main SDK class
