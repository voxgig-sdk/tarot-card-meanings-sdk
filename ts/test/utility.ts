...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.TAROTCARDMEANINGS_TEST_LIVE ||
    'TRUE' === process.env.TAROTCARDMEANINGS_TEST_OVERRIDE
  ) {
  ...
  m.TAROTCARDMEANINGS_TEST_EXPLAIN = process.env.TAROTCARDMEANINGS_TEST_EXPLAIN || m.TAROTCARDMEANINGS_TEST_EXPLAIN
