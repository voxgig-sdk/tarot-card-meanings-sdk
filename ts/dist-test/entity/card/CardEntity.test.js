...
(0, node_test_1.describe)('CardEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.TarotCardMeaningsSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TAROT_CARD_MEANINGS_TEST_CARD_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.TarotCardMeaningsSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['TAROT_CARD_MEANINGS_TEST_CARD_ENTID'];
    ...
    if (live) {
        client = new __1.TarotCardMeaningsSDK(merge([
