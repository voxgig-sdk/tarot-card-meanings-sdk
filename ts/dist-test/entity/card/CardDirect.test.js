...
(0, node_test_1.describe)('CardDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('TAROT_CARD_MEANINGS_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TarotCardMeaningsSDK({
...
function liveScenariosActive() { return false && process.env.TAROT_CARD_MEANINGS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TarotCardMeaningsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TAROT_CARD_MEANINGS_TEST_CARD_ENTID'];
    ...
    const client = new __1.TarotCardMeaningsSDK({
        base: 'http://localhost:8080',
