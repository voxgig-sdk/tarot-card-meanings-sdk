...
function envOverride(m) {
    if ('TRUE' === process.env.TAROT_CARD_MEANINGS_TEST_LIVE ||
        'TRUE' === process.env.TAROT_CARD_MEANINGS_TEST_OVERRIDE) {
    ...
    m.TAROT_CARD_MEANINGS_TEST_EXPLAIN = process.env.TAROT_CARD_MEANINGS_TEST_EXPLAIN || m.TAROT_CARD_MEANINGS_TEST_EXPLAIN;
    return m;
}
