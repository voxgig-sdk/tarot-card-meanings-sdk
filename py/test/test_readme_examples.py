# TarotCardMeanings SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TarotCardMeaningsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TarotCardMeaningsSDK(...) and TarotCardMeaningsSDK.test(...) become
#      TarotCardMeaningsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tarotcardmeanings_sdk"
_SDK_CLASS = "TarotCardMeaningsSDK"
