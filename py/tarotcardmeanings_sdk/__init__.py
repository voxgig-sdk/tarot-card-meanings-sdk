...
from tarotcardmeanings_sdk.utility import register

# Load features
from tarotcardmeanings_sdk.feature.base_feature import TarotCardMeaningsBaseFeature
from tarotcardmeanings_sdk.features import _has_feature, _make_feature
...
class TarotCardMeaningsSDK:
    ...
    def get_utility(self):
        return TarotCardMeaningsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TarotCardMeaningsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Card(self, data=None) -> "CardEntity":
        ...
        from tarotcardmeanings_sdk.entity.card_entity import CardEntity
